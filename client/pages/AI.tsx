  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      ...
      role: "assistant",
      content:
        "Welcome to ChatKing AI! I'm powered by OpenRouter and have access to cutting-edge models like DeepSeek R1, Gemma 2 27B, and more. How can I assist you today?",
      timestamp: new Date(),
  ...
  const loadChatSession = async (sessionId: string) => {
    try {
      const response = await fetch(
        `/api/ai/session/${sessionId}?userId=${userId}`,
      );
      const data = await response.json();
          ...
          <div className="glass border-b border-border-glow p-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h1 className="font-orbitron font-bold text-xl text-glow-cyber">
                    ChatKing AI
                  </h1>
