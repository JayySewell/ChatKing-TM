            ...
            <div className="space-y-8 text-text-primary">
              <section>
                ...
                <p className="text-text-muted leading-relaxed">
                  By accessing and using ChatKing ("the Service"), you accept
                  and agree to be bound by the terms and provision of this
                  agreement. ChatKing is owned and operated by ChatKing. All
                  rights reserved.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="text-text-muted leading-relaxed mb-4">
                  ChatKing is a next-generation all-in-one AI platform that
                  provides:
                </p>
                <ul className="list-disc list-inside text-text-muted space-y-2 ml-4">
                  ...
                  <li>
                    Vector database and knowledge indexing through Pinecone
                  </li>
                  <li>
                    Scientific calculator with advanced mathematical functions
                  </li>
                  <li>
                    Secure, encrypted data storage using our proprietary
                    CK-Storage system
                  </li>
                </ul>
              </section>
              ...
              <section>
                ...
                <ul className="list-disc list-inside text-text-muted space-y-2 ml-4">
                  ...
                  <li>
                    We use our proprietary CK-Storage system for secure, local
                    data storage
                  </li>
                  <li>
                    No personal data is shared with third parties without
                    explicit consent
                  </li>
              ...
              <section>
                ...
                <p className="text-text-muted leading-relaxed">
                  ...
                  ChatKing and its licensors. The Service is protected by
              ...
              <section>
                <h2 className="text-2xl font-bold text-cyber-blue mb-4">
                  7. API Usage and Third-Party Services
                </h2>
                <p className="text-text-muted leading-relaxed mb-4">
                ...
                <p className="text-text-muted leading-relaxed">
                  These integrations are subject to their respective terms of
              ...
              <section>
                ...
                <p className="text-text-muted leading-relaxed">
                  ChatKing shall not be liable for any indirect, incidental,
              ...
              <section>
                ...
                <p className="text-text-muted leading-relaxed">
                  ...
                  contact us through the platform or reach out to our support
                  team.
                </p>
              </section>
