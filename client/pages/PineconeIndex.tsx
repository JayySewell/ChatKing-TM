...
export default function PineconeIndex() {
  const [activeTab, setActiveTab] = useState<"search" | "manage" | "upload">(
    "search",
  );
  ...
  const [newIndexMetric, setNewIndexMetric] = useState<
  ...
  const loadIndexStats = async (indexName: string) => {
    try {
      const response = await fetch(
        `/api/pinecone/stats/${indexName}?userId=${userId}`,
      );
      const data = await response.json();
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-text-muted text-lg">
              Knowledge indexing and vector search for intelligent data
              retrieval
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
                ...
                <div className="space-y-6">
                  ...
                  <div className="glass-card">
                    ...
                    <p className="text-sm text-text-muted">
                      ...
                      {pineconeIndexes.length + userIndexes.length} knowledge
                      indexes
                    </p>
                  </div>
                      ...
                      !isSearching && (
                        <div className="text-center py-12">
                          ...
                          <p className="text-text-muted">
                            Try different keywords or upload more documents to
                            your knowledge base.
                          </p>
                        </div>
                      )}
                    ...
                    {!searchQuery && (
                      <div className="text-center py-12">
                        ...
                        <p className="text-text-muted mb-6">
                          Enter a query to search across all your indexed
                          documents and data.
                        </p>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-md mx-auto">
                          ...
                          >
                            <div className="font-medium text-neon-purple">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                      ...
                      <div>
                        ...
                        <select
                          ...
                          onChange={(e) =>
                            setNewIndexDimension(Number(e.target.value))
                          }
                          className="w-full cyber-input"
                        >
                      ...
                      <div>
                        ...
                        <select
                          ...
                          onChange={(e) =>
                            setNewIndexMetric(e.target.value as any)
                          }
                          className="w-full cyber-input"
                        >
                  ...
                  <div className="glass-card">
                      ...
                      {pineconeIndexes.map((index) => (
                        ...
                        >
                          ...
                          <div className="text-sm text-text-muted space-y-1">
                            ...
                            <div>
                              Vectors: {index.vectorCount.toLocaleString()}
                            </div>
                          </div>
                        </div>
                      ))}
                    ...
                    {pineconeIndexes.length === 0 && (
                      <div className="text-center py-8">
                        ...
                        <p className="text-text-muted">
                          No indexes found. Create your first index above.
                        </p>
                      </div>
                    )}
                  </div>
                  ...
                  <div className="glass-card">
                    ...
                    {selectedIndex ? (
                          ...
                          >
                            {pineconeIndexes.map((index) => (
                              <option key={index.name} value={index.name}>
                                {index.name} (
                                {index.vectorCount.toLocaleString()} vectors)
                              </option>
                            ))}
                          </select>
                        </div>
                      ...
                      <div className="text-center py-8">
                        ...
                        <p className="text-text-muted">
                          Select or create an index first to upload documents.
                        </p>
                      </div>
                    )}
                  </div>
            ...
            <div className="lg:col-span-1 space-y-6">
              ...
              {/* API Status */}
              <div className="glass-card">
                <h4 className="font-semibold text-lg mb-3 text-text-primary">
                  API Status
                </h4>
                <div className="space-y-2">
