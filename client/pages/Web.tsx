    ...
    switch (type) {
      ...
      case "news":
        return Array.from({ length: 10 }, (_, i) => ({
          ...
          source: ["BBC News", "CNN", "Reuters", "Associated Press", "NPR"][
            i % 5
          ],
        }));
                ...
                <div className="flex items-start space-x-4 p-4">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex items-center space-x-4 text-xs text-text-muted">
                      ...
                      <span>
                        Open until {Math.floor(Math.random() * 12) + 6}:00 PM
                      </span>
                    </div>
                  </div>
                </div>
          ...
          <div className="glass-card">
            <div className="p-6 text-center">
              ...
              <p className="text-text-muted mb-6">
                AI-powered search assistant that helps you find exactly what
                you're looking for
              </p>
              <div className="space-y-4">
                <div className="text-left">
                  <div className="flex items-start space-x-3 mb-4">
                    ...
                    <div className="flex-1">
                      <p className="text-text-primary">
                        I can help you search for "{currentQuery}" across
                        multiple sources and provide detailed insights.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="bg-secondary-bg rounded-lg p-4 mb-4">
                    ...
                    <ul className="text-text-muted text-sm space-y-1">
                      <li>
                        • Found {Math.floor(Math.random() * 10000)} relevant web
                        results
                      </li>
                      <li>
                        • {Math.floor(Math.random() * 50)} recent news articles
                      </li>
                      <li>
                        • {Math.floor(Math.random() * 100)} related images and
                        videos
                      </li>
                      <li>
                        • {Math.floor(Math.random() * 20)} local business
                        listings
                      </li>
                    </ul>
                  </div>
      ...
      return (
        <div className="space-y-6">
          <div className="text-center mb-8">
            ...
            <p className="text-text-muted">
              Powerful utilities and tools for developers and users
            </p>
          </div>
              ...
              <div className="mb-6">
                <div className="flex items-center justify-between">
                  <h2 className="text-2xl font-bold text-text-primary">
                    {activeSearchType === "search"
                      ? "Search"
                      : activeSearchType.charAt(0).toUpperCase() +
                        activeSearchType.slice(1)}{" "}
            ...
            {currentQuery ? (
              ...
              <div className="text-center py-12">
                ...
                <p className="text-text-muted text-lg mb-8 max-w-2xl mx-auto">
                  Privacy-focused web search powered by BraveSearch with
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-6 max-w-4xl mx-auto">
                  ...
                  <div className="glass-card text-center">
                    ...
                    <p className="text-text-muted text-sm">
                      Built-in utilities and converters
                    </p>
                  </div>
                  <div className="glass-card text-center">
