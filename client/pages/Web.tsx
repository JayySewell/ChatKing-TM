...
export default function Web() {
  ...
  const [searchType, setSearchType] = useState<'web' | 'news' | 'images' | 'videos'>('web');
            ...
            <div className="max-w-7xl mx-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <div className="font-medium text-text-primary">VPN Status</div>
                    <div className="text-sm text-text-muted">Ready for secure browsing</div>
                  </div>
                </div>
              </div>
            </div>
              ...
              {!currentQuery && (
                <div className="text-center py-12">
                  ...
                  <p className="text-text-muted text-lg mb-8 max-w-2xl mx-auto">
                    Privacy-focused web search powered by BraveSearch. 
                    Browse with confidence using built-in tracking protection and VPN capabilities.
                  </p>
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-3xl mx-auto">
                    ...
                    <div className="glass-card text-center">
                      ...
                      <h3 className="font-semibold text-text-primary mb-2">VPN Ready</h3>
                      <p className="text-text-muted text-sm">Secure global browsing</p>
                    </div>
                    <div className="glass-card text-center">
                      <Search className="w-8 h-8 mx-auto mb-3 text-cyber-blue" />
                      <h3 className="font-semibold text-text-primary mb-2">Fast Results</h3>
                      <p className="text-text-muted text-sm">Powered by BraveSearch</p>
                    </div>
                  </div>
                </div>
              )}
