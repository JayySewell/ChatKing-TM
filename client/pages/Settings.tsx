...
export default function Settings() {
  ...
  if (isLoading) {
    return (
      <Layout isAuthenticated={true} isOwner={profile?.isOwner} username={profile?.username}>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          {activeTab === 'profile' && (
            <div className="glass-card">
              <h3 className="font-semibold text-xl mb-6 text-text-primary">Profile Settings</h3>
          ...
          {activeTab === 'security' && (
            <div className="glass-card">
              <h3 className="font-semibold text-xl mb-6 text-text-primary">Security Settings</h3>
              ...
              <div className="space-y-6">
                ...
                <div className="border-t border-border-glow pt-6">
                  <h4 className="font-medium text-text-primary mb-3">Account Security</h4>
          ...
          {activeTab === 'privacy' && (
            <div className="glass-card">
              <h3 className="font-semibold text-xl mb-6 text-text-primary">Privacy Settings</h3>
              ...
              <div className="space-y-6">
                <div>
                  ...
                  >
                    ...
                    <option value="enhanced">Enhanced - Maximum privacy protection</option>
                  </select>
                ...
                <div className="space-y-3">
                  ...
                  <div className="space-y-2">
                    <label className="flex items-center space-x-3">
                      ...
                      <span className="text-text-primary">Analytics and usage data</span>
                    </label>
                    <label className="flex items-center space-x-3">
                      <input type="checkbox" className="rounded" defaultChecked />
                      <span className="text-text-primary">Error reporting and diagnostics</span>
                    </label>
                    <label className="flex items-center space-x-3">
                      <input type="checkbox" className="rounded" />
                      <span className="text-text-primary">Performance monitoring</span>
                    </label>
                  </div>
                </div>
          ...
          {activeTab === 'data' && (
            <div className="glass-card">
              <h3 className="font-semibold text-xl mb-6 text-text-primary">Data Management</h3>
              
              <div className="space-y-8">
                <div>
                  <h4 className="font-medium text-text-primary mb-4">Export Your Data</h4>
                  <p className="text-text-muted text-sm mb-4">
                    Download all your ChatKing data including conversations, search history, and settings.
                  </p>
                  <button
                ...
                <div className="border-t border-border-glow pt-6">
                  <h4 className="font-medium text-text-primary mb-4">Import Data</h4>
                  <p className="text-text-muted text-sm mb-4">
                    Import previously exported ChatKing data or migrate from another platform.
                  </p>
                ...
                <div className="border-t border-border-glow pt-6">
                  <h4 className="font-medium text-neon-red mb-4">Danger Zone</h4>
                  <p className="text-text-muted text-sm mb-4">
          ...
          {profile && (
            <div className="mt-8 glass-card">
              <h3 className="font-semibold text-lg mb-4 text-text-primary">Account Information</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                <div>
                  <span className="text-text-muted">Account Type:</span>
                  <span className="ml-2 text-text-primary">
                    {profile.isOwner ? 'Owner' : 'User'}
                    {profile.isOwner && <span className="text-neon-amber ml-1">👑</span>}
                  </span>
                </div>
                <div>
